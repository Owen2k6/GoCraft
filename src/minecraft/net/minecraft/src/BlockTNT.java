...
public class BlockTNT extends Block {
    ...
    public void onNeighborBlockChange(World var1, int var2, int var3, int var4, int var5) {
        if (var5 > 0 && blocksList[var5].canProvidePower() && var1.isBlockIndirectlyGettingPowered(var2, var3, var4)) {
            this.onBlockDestroyedByPlayer(var1, var2, var3, var4, 1);
            var1.setBlockWithNotify(var2, var3, var4, 0);
        }
    ...
    public void onBlockDestroyedByPlayer(World var1, int var2, int var3, int var4, int var5) {
        if (!var1.multiplayerWorld) {
            if ((var5 & 1) == 0) {
                this.dropBlockAsItem_do(var1, var2, var3, var4, new ItemStack(tnt.blockID, 1, 0));
            } else {
