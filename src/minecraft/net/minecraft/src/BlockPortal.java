...
public class BlockPortal extends BlockBreakable {
    ...
    public boolean tryToCreatePortal(World var1, int var2, int var3, int var4) {
        byte var5 = 0;
        byte var6 = 0;
        if (var1.getBlockId(var2 - 1, var3, var4) == obsidian.blockID || var1.getBlockId(var2 + 1, var3, var4) == obsidian.blockID) {
            var5 = 1;
        }

        if (var1.getBlockId(var2, var3, var4 - 1) == obsidian.blockID || var1.getBlockId(var2, var3, var4 + 1) == obsidian.blockID) {
            var6 = 1;
        }
        ...
        if (var5 == var6) {
            ...
            for(var7 = 0; var7 < 2; ++var7) {
                for(var8 = 0; var8 < 3; ++var8) {
                    var1.setBlockWithNotify(var2 + var5 * var7, var3 + var8, var4 + var6 * var7, portal.blockID);
                }
            }
    ...
    public void onNeighborBlockChange(World var1, int var2, int var3, int var4, int var5) {
        ...
        if (var1.getBlockId(var2, var8 - 1, var4) != obsidian.blockID) {
            ...
            if (var9 == 3 && var1.getBlockId(var2, var8 + var9, var4) == obsidian.blockID) {
                ...
                if (var10 && var11) {
                    var1.setBlockWithNotify(var2, var3, var4, 0);
                } else if ((var1.getBlockId(var2 + var6, var3, var4 + var7) != obsidian.blockID || var1.getBlockId(var2 - var6, var3, var4 - var7) != this.blockID) && (var1.getBlockId(var2 - var6, var3, var4 - var7) != obsidian.blockID || var1.getBlockId(var2 + var6, var3, var4 + var7) != this.blockID)) {
                    var1.setBlockWithNotify(var2, var3, var4, 0);
                }
            } else {
                var1.setBlockWithNotify(var2, var3, var4, 0);
