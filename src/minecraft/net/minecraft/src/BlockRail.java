...
public class BlockRail extends Block {
    ...
    public static final boolean isRailBlockAt(World var0, int var1, int var2, int var3) {
        ...
        return var4 == rail.blockID || var4 == railPowered.blockID || var4 == railDetector.blockID;
    }

    public static final boolean isRailBlock(int var0) {
        return var0 == rail.blockID || var0 == railPowered.blockID || var0 == railDetector.blockID;
    }
    ...
    public int getBlockTextureFromSideAndMetadata(int var1, int var2) {
        if (this.isPowered) {
            if (this.blockID == railPowered.blockID && (var2 & 8) == 0) {
    ...
    public void onNeighborBlockChange(World var1, int var2, int var3, int var4, int var5) {
        if (!var1.multiplayerWorld) {
            ...
            } else if (this.blockID == railPowered.blockID) {
            ...
            } else if (var5 > 0 && blocksList[var5].canProvidePower() && !this.isPowered && RailLogic.getNAdjacentTracks(new RailLogic(this, var1, var2, var3, var4)) == 3) {
