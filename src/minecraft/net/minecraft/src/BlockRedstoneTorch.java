...
public class BlockRedstoneTorch extends BlockTorch {
    ...
    public int getBlockTextureFromSideAndMetadata(int var1, int var2) {
        return var1 == 1 ? redstoneWire.getBlockTextureFromSideAndMetadata(var1, var2) : super.getBlockTextureFromSideAndMetadata(var1, var2);
    }
    ...
    public void updateTick(World var1, int var2, int var3, int var4, Random var5) {
        ...
        if (this.torchActive) {
            if (var6) {
                var1.setBlockAndMetadataWithNotify(var2, var3, var4, torchRedstoneIdle.blockID, var1.getBlockMetadata(var2, var3, var4));
            ...
            var1.setBlockAndMetadataWithNotify(var2, var3, var4, torchRedstoneActive.blockID, var1.getBlockMetadata(var2, var3, var4));
        }
