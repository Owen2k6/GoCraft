...
public class BlockFlowing extends BlockFluid {
        ...
        if (this.liquidCanDisplaceBlock(var1, var2, var3, var4)) {
            ...
            if (var6 > 0) {
                if (this.blockMaterial == Material.lava) {
                    ...
                    blocksList[var6].dropBlockAsItem(var1, var2, var3, var4, var1.getBlockMetadata(var2, var3, var4));
                }
            }
    ...
    private boolean blockBlocksFlow(World var1, int var2, int var3, int var4) {
        ...
        if (var5 != doorWood.blockID && var5 != doorSteel.blockID && var5 != signPost.blockID && var5 != ladder.blockID && var5 != reed.blockID) {
            if (var5 == 0) {
                return false;
            } else {
