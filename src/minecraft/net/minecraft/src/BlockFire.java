...
public class BlockFire extends Block {
    ...
    public void initializeBlock() {
        ...
        this.setBurnRate(stairCompactPlanks.blockID, 5, 20);
    ...
    public void updateTick(World var1, int var2, int var3, int var4, Random var5) {
        boolean var6 = var1.getBlockId(var2, var3 - 1, var4) == netherrack.blockID;
    ...
    private void tryToCatchBlockOnFire(World var1, int var2, int var3, int var4, int var5, Random var6, int var7) {
        ...
        if (var6.nextInt(var5) < var8) {
            boolean var9 = var1.getBlockId(var2, var3, var4) == tnt.blockID;
            ...
            if (var9) {
                tnt.onBlockDestroyedByPlayer(var1, var2, var3, var4, 1);
            }
        }
    ...
    public void onBlockAdded(World var1, int var2, int var3, int var4) {
        if (var1.getBlockId(var2, var3 - 1, var4) != obsidian.blockID || !portal.tryToCreatePortal(var1, var2, var3, var4)) {
            if (!var1.isBlockNormalCube(var2, var3 - 1, var4) && !this.canNeighborCatchFire(var1, var2, var3, var4)) {
                var1.setBlockWithNotify(var2, var3, var4, 0);
            } else {
                var1.scheduleBlockUpdate(var2, var3, var4, this.blockID, this.tickRate());
