...
public class GuiIngameMenu extends GuiScreen {
    ...
    public void initGui() {
        ...
        byte var1 = -16;
        this.controlList.add(new GuiButton(1, this.width / 2 - 100, this.height / 4 + 120 + var1, "Quit to Main Menu"));
        if (this.mc.isMultiplayerWorld()) {
            ((GuiButton)this.controlList.get(0)).displayString = "Leave Server";
        }
    ...
    public void drawScreen(int var1, int var2, float var3) {
        ...
        this.drawCenteredString(this.fontRenderer, "Game Paused", this.width / 2, 40, 16777215);
        if (this.mc.isMultiplayerWorld()) {
