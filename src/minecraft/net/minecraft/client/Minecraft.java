...
import java.io.File;
import minecraft.net.minecraft.src.AchievementList;
import minecraft.net.minecraft.src.AxisAlignedBB;
import minecraft.net.minecraft.src.Block;
import minecraft.net.minecraft.src.ChunkCoordinates;
import minecraft.net.minecraft.src.ChunkProviderLoadOrGenerate;
import minecraft.net.minecraft.src.ColorizerFoliage;
import minecraft.net.minecraft.src.ColorizerGrass;
import minecraft.net.minecraft.src.ColorizerWater;
import minecraft.net.minecraft.src.EffectRenderer;
import minecraft.net.minecraft.src.EntityClientPlayerMP;
import minecraft.net.minecraft.src.EntityLiving;
import minecraft.net.minecraft.src.EntityPlayer;
import minecraft.net.minecraft.src.EntityPlayerSP;
import minecraft.net.minecraft.src.EntityRenderer;
import minecraft.net.minecraft.src.EnumMovingObjectType;
import minecraft.net.minecraft.src.EnumOS2;
import minecraft.net.minecraft.src.EnumOSMappingHelper;
import minecraft.net.minecraft.src.EnumOptions;
import minecraft.net.minecraft.src.FontRenderer;
import minecraft.net.minecraft.src.GLAllocation;
import minecraft.net.minecraft.src.GameSettings;
import minecraft.net.minecraft.src.GameWindowListener;
import minecraft.net.minecraft.src.GuiAchievement;
import minecraft.net.minecraft.src.GuiChat;
import minecraft.net.minecraft.src.GuiConflictWarning;
import minecraft.net.minecraft.src.GuiConnecting;
import minecraft.net.minecraft.src.GuiErrorScreen;
import minecraft.net.minecraft.src.GuiGameOver;
import minecraft.net.minecraft.src.GuiIngame;
import minecraft.net.minecraft.src.GuiIngameMenu;
import minecraft.net.minecraft.src.GuiInventory;
import minecraft.net.minecraft.src.GuiMainMenu;
import minecraft.net.minecraft.src.GuiScreen;
import minecraft.net.minecraft.src.GuiSleepMP;
import minecraft.net.minecraft.src.GuiUnused;
import minecraft.net.minecraft.src.IChunkProvider;
import minecraft.net.minecraft.src.ISaveFormat;
import minecraft.net.minecraft.src.ISaveHandler;
import minecraft.net.minecraft.src.ItemRenderer;
import minecraft.net.minecraft.src.ItemStack;
import minecraft.net.minecraft.src.LoadingScreenRenderer;
import minecraft.net.minecraft.src.MathHelper;
import minecraft.net.minecraft.src.MinecraftError;
import minecraft.net.minecraft.src.MinecraftException;
import minecraft.net.minecraft.src.MinecraftImpl;
import minecraft.net.minecraft.src.ModelBiped;
import minecraft.net.minecraft.src.MouseHelper;
import minecraft.net.minecraft.src.MovementInputFromOptions;
import minecraft.net.minecraft.src.MovingObjectPosition;
import minecraft.net.minecraft.src.minecraft.netClientHandler;
import minecraft.net.minecraft.src.OpenGlCapsChecker;
import minecraft.net.minecraft.src.PlayerController;
import minecraft.net.minecraft.src.PlayerControllerTest;
import minecraft.net.minecraft.src.RenderBlocks;
import minecraft.net.minecraft.src.RenderEngine;
import minecraft.net.minecraft.src.RenderGlobal;
import minecraft.net.minecraft.src.RenderManager;
import minecraft.net.minecraft.src.SaveConverterMcRegion;
import minecraft.net.minecraft.src.ScaledResolution;
import minecraft.net.minecraft.src.ScreenShotHelper;
import minecraft.net.minecraft.src.Session;
import minecraft.net.minecraft.src.SoundManager;
import minecraft.net.minecraft.src.StatFileWriter;
import minecraft.net.minecraft.src.StatList;
import minecraft.net.minecraft.src.StatStringFormatKeyInv;
import minecraft.net.minecraft.src.Teleporter;
import minecraft.net.minecraft.src.Tessellator;
import minecraft.net.minecraft.src.TextureCompassFX;
import minecraft.net.minecraft.src.TextureFlamesFX;
import minecraft.net.minecraft.src.TextureLavaFX;
import minecraft.net.minecraft.src.TextureLavaFlowFX;
import minecraft.net.minecraft.src.TexturePackList;
import minecraft.net.minecraft.src.TexturePortalFX;
import minecraft.net.minecraft.src.TextureWatchFX;
import minecraft.net.minecraft.src.TextureWaterFX;
import minecraft.net.minecraft.src.TextureWaterFlowFX;
import minecraft.net.minecraft.src.ThreadCheckHasPaid;
import minecraft.net.minecraft.src.ThreadDownloadResources;
import minecraft.net.minecraft.src.ThreadSleepForever;
import minecraft.net.minecraft.src.Timer;
import minecraft.net.minecraft.src.UnexpectedThrowable;
import minecraft.net.minecraft.src.Vec3D;
import minecraft.net.minecraft.src.World;
import minecraft.net.minecraft.src.WorldProvider;
import minecraft.net.minecraft.src.WorldRenderer;
import org.lwjgl.lwjgl.jar;
...
public abstract class Minecraft implements Runnable {
    ...
    public void startGame() throws LWJGLException {
        ...
        Display.setTitle("Minecraft Minecraft Java Rewritten DEV TEST");
    ...
    public void usePortal() {
        ...
        if (this.thePlayer.dimension == -1) {
            ...
            this.changeWorld(var7, "Entering the minecraft.nether", this.thePlayer);
        } else {
            var1 *= var5;
            var3 *= var5;
            this.thePlayer.setLocationAndAngles(var1, this.thePlayer.posY, var3, this.thePlayer.rotationYaw, this.thePlayer.rotationPitch);
            ...
            this.changeWorld(var7, "Leaving the minecraft.nether", this.thePlayer);
        }
    ...
    public static void startMainThread(String var0, String var1, String var2) {
        ...
        var8.setPriority(10);
        var7.minecraftUri = "www.minecraft.minecraft.net";
    ...
    public minecraft.netClientHandler getSendQueue() {
