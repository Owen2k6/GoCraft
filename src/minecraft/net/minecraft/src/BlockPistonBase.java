...
public class BlockPistonBase extends Block {
    ...
    public void playBlock(World var1, int var2, int var3, int var4, int var5, int var6) {
        ...
        if (var5 == 0) {
            ...
            var1.setBlockAndMetadata(var2, var3, var4, pistonMoving.blockID, var6);
            ...
            if (this.isSticky) {
                ...
                if (var14 || var12 <= 0 || !canPushBlock(var12, var1, var9, var10, var11, false) || blocksList[var12].getMobilityFlag() != 0 && var12 != pistonBase.blockID && var12 != pistonStickyBase.blockID) {
                    if (!var14) {
                    ...
                    var1.setBlockAndMetadata(var2, var3, var4, pistonMoving.blockID, var13);
    ...
    private static boolean canPushBlock(int var0, World var1, int var2, int var3, int var4, boolean var5) {
        if (var0 == obsidian.blockID) {
            return false;
        } else {
            if (var0 != pistonBase.blockID && var0 != pistonStickyBase.blockID) {
                if (blocksList[var0].getHardness() == -1.0F) {
                    return false;
                }

                if (blocksList[var0].getMobilityFlag() == 2) {
                    return false;
                }

                if (!var5 && blocksList[var0].getMobilityFlag() == 1) {
                    return false;
                }
    ...
    private boolean tryExtend(World var1, int var2, int var3, int var4, int var5) {
        ...
        while(var9 < 13) {
            if (var7 > 0 && var7 < 127) {
                ...
                if (var10 != 0) {
                    ...
                    blocksList[var10].dropBlockAsItem(var1, var6, var7, var8, var1.getBlockMetadata(var6, var7, var8));
        ...
        while(var6 != var2 || var7 != var3 || var8 != var4) {
            ...
            if (var12 == this.blockID && var9 == var2 && var10 == var3 && var11 == var4) {
                var1.setBlockAndMetadata(var6, var7, var8, pistonMoving.blockID, var5 | (this.isSticky ? 8 : 0));
                var1.setBlockTileEntity(var6, var7, var8, BlockPistonMoving.getNewTileEntity(pistonExtension.blockID, var5 | (this.isSticky ? 8 : 0), var5, true, false));
            } else {
                var1.setBlockAndMetadata(var6, var7, var8, pistonMoving.blockID, var13);
