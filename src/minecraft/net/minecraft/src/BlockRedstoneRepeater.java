...
public class BlockRedstoneRepeater extends Block {
    ...
    public void updateTick(World var1, int var2, int var3, int var4, Random var5) {
        ...
        if (this.isRepeaterPowered && !var7) {
            var1.setBlockAndMetadataWithNotify(var2, var3, var4, redstoneRepeaterIdle.blockID, var6);
        } else if (!this.isRepeaterPowered) {
            var1.setBlockAndMetadataWithNotify(var2, var3, var4, redstoneRepeaterActive.blockID, var6);
            if (!var7) {
                int var8 = (var6 & 12) >> 2;
                var1.scheduleBlockUpdate(var2, var3, var4, redstoneRepeaterActive.blockID, field_22023_b[var8] * 2);
            }
        }
    ...
    private boolean ignoreTick(World var1, int var2, int var3, int var4, int var5) {
        ...
        switch(var6) {
        case 0:
            return var1.isBlockIndirectlyProvidingPowerTo(var2, var3, var4 + 1, 3) || var1.getBlockId(var2, var3, var4 + 1) == redstoneWire.blockID && var1.getBlockMetadata(var2, var3, var4 + 1) > 0;
        case 1:
            return var1.isBlockIndirectlyProvidingPowerTo(var2 - 1, var3, var4, 4) || var1.getBlockId(var2 - 1, var3, var4) == redstoneWire.blockID && var1.getBlockMetadata(var2 - 1, var3, var4) > 0;
        case 2:
            return var1.isBlockIndirectlyProvidingPowerTo(var2, var3, var4 - 1, 2) || var1.getBlockId(var2, var3, var4 - 1) == redstoneWire.blockID && var1.getBlockMetadata(var2, var3, var4 - 1) > 0;
        case 3:
            return var1.isBlockIndirectlyProvidingPowerTo(var2 + 1, var3, var4, 5) || var1.getBlockId(var2 + 1, var3, var4) == redstoneWire.blockID && var1.getBlockMetadata(var2 + 1, var3, var4) > 0;
        default:
            return false;
        }
    }
