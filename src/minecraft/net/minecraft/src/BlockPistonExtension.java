...
public class BlockPistonExtension extends Block {
    ...
    public void onBlockRemoval(World var1, int var2, int var3, int var4) {
        ...
        if (var7 == pistonBase.blockID || var7 == pistonStickyBase.blockID) {
            ...
            if (BlockPistonBase.isPowered(var5)) {
                blocksList[var7].dropBlockAsItem(var1, var2, var3, var4, var5);
    ...
    public void onNeighborBlockChange(World var1, int var2, int var3, int var4, int var5) {
        ...
        if (var7 != pistonBase.blockID && var7 != pistonStickyBase.blockID) {
            ...
            blocksList[var7].onNeighborBlockChange(var1, var2 - PistonBlockTextures.offsetsXForSide[var6], var3 - PistonBlockTextures.offsetsYForSide[var6], var4 - PistonBlockTextures.offsetsZForSide[var6], var5);
        }
