        ...
        if (var5 == 1) {
            ...
            if (var6 != this.blockID && var7 != this.blockID) {
                if (var8 != this.blockID && var9 != this.blockID) {
                    byte var14 = 3;
                    if (opaqueCubeLookup[var6] && !opaqueCubeLookup[var7]) {
                        var14 = 3;
                    }

                    if (opaqueCubeLookup[var7] && !opaqueCubeLookup[var6]) {
                        var14 = 2;
                    }

                    if (opaqueCubeLookup[var8] && !opaqueCubeLookup[var9]) {
                        var14 = 5;
                    }

                    if (opaqueCubeLookup[var9] && !opaqueCubeLookup[var8]) {
                        var14 = 4;
                    }
                    ...
                    var13 = 3;
                    if ((opaqueCubeLookup[var6] || opaqueCubeLookup[var11]) && !opaqueCubeLookup[var7] && !opaqueCubeLookup[var12]) {
                        var13 = 3;
                    }

                    if ((opaqueCubeLookup[var7] || opaqueCubeLookup[var12]) && !opaqueCubeLookup[var6] && !opaqueCubeLookup[var11]) {
                        var13 = 2;
                    }
                ...
                var13 = 5;
                if ((opaqueCubeLookup[var8] || opaqueCubeLookup[var11]) && !opaqueCubeLookup[var9] && !opaqueCubeLookup[var12]) {
                    var13 = 5;
                }

                if ((opaqueCubeLookup[var9] || opaqueCubeLookup[var12]) && !opaqueCubeLookup[var8] && !opaqueCubeLookup[var11]) {
                    var13 = 4;
                }
