...
public class BlockIce extends BlockBreakable {
    ...
    public void harvestBlock(World var1, EntityPlayer var2, int var3, int var4, int var5, int var6) {
        ...
        if (var7.getIsSolid() || var7.getIsLiquid()) {
            var1.setBlockWithNotify(var3, var4, var5, waterMoving.blockID);
        }
    ...
    public void updateTick(World var1, int var2, int var3, int var4, Random var5) {
        if (var1.getSavedLightValue(EnumSkyBlock.Block, var2, var3, var4) > 11 - lightOpacity[this.blockID]) {
            this.dropBlockAsItem(var1, var2, var3, var4, var1.getBlockMetadata(var2, var3, var4));
            var1.setBlockWithNotify(var2, var3, var4, waterStill.blockID);
        }
